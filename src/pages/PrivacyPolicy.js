...
const PrivacyPolicy = ({ setState, setClick }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <>
      ...
      <section style={{ paddingTop: "9em" }}>
        <div class="page">
          {/* <div>
            <div class="container">
              <p class="title">Privacy Policy for Incretech</p>
            </div>
          </div> */}
          <div class="translations-content-container">
            <div class="container">
              ...
              >
                ...
                <p className="text" style={{ marginBottom: ".4em" }}>
                ...
                <h2
                  className="heading-secondary-policy"
                  Best
                  CCTV
                  and
                  Intercom
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Incretech Pvt
                      Ltd, N 1/A, 39/2, SECTOR 10, Dr B R Ambedkar Marg, Nerul
                      West, LT, Navi Mumbai, Maharashtra 400706.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Incretech, accessible
                      from{" "}
                      <a
                        href="https://incretech.in/"
                ...
                <h3 className="heading-tertiary-policy">
                  Types of Data Collected
                </h3>
                <h3 className="heading-tertiary-policy">Personal Data</h3>
                <p>
                ...
                <h3 className="heading-tertiary-policy">Usage Data</h3>
                <p>
                ...
                <h3 className="heading-tertiary-policy">Law enforcement</h3>
                <p>
                ...
                <h3 className="heading-tertiary-policy">Children's Privacy</h3>
                <p>
                ...
                <h3 className="heading-tertiary-policy">Contact Us</h3>
                <p>
                ...
                <ul>
                  <li>
                    ...
                    <a
                      className=" hover"
                      href="https://accounts.google.com/b/1/AddMailService"
                      target="_blank"
                      // data-cfemail="2e4d41405a4f4d5a0057415b5a465a4b4d464041424149576e49434f4742004d4143"
                    >
                      [ contact@incretech.in ]
                    </a>
                  </li>
                </ul>
              </div>
