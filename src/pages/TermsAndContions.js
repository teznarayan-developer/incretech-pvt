...
const TermsAndConditions = ({ setState, setClick }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
              ...
              <div class="row">
                <div class="col-md-12">
                  <h2
                    ...
                    Navi
                    Mumbai
                    className="heading-secondary-terms"
                  >
                    <strong>Terms and Conditions</strong>
                  </h2>
                  <p>Welcome to Incretech!</p>
                  <p>
                    These terms and conditions outline the rules and regulations
                    for the use of Incretech Pvt Ltd's Website, located at
                    https://incretechprivatelimited.in/.
                  </p>
                  <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Incretech if you do
                  ...
                  <h3 className="heading-tertiary-terms">
                    <strong>Cookies</strong>
                  </h3>
                  <p>
                    We employ the use of cookies. By accessing Incretech, you
                    agreed to use cookies in agreement with the Incretech Pvt
                  ...
                  <p>
                    Unless otherwise stated, Incretech Pvt Ltd and/or its
                    licensors own the intellectual property rights for all
                    material on Incretech. All intellectual property rights are
                    reserved. You may access this from Incretech for your own
                    personal use subjected to restrictions set in these terms
                    and conditions.
                  </p>
                  <p>You must not:</p>
                  <ul>
                    <li>Republish material from Incretech</li>
                    <li>Sell, rent or sub-license material from Incretech</li>
                    <li>
                      Reproduce, duplicate or copy material from Incretech
                    </li>
                    <li>Redistribute content from Incretech</li>
                  </ul>
                  <p>
                  ...
                  <p>
                    Incretech Pvt Ltd reserves the right to monitor all Comments
                  ...
                  <p>
                    You hereby grant Incretech Pvt Ltd a non-exclusive license
                  ...
                  <p>
                    ...
                    compensates the absence of Incretech Pvt Ltd; and (d) the
                  ...
                  <p>
                    ...
                    inform us by sending an e-mail to Incretech Pvt Ltd. Please
                  ...
                  <p>
                    No use of Incretech Pvt Ltd's logo or other artwork will be
